...
for module in "${mods[@]}"; do
    ...
    for provider in "${providers[@]}"; do
        ...
        dotnet-ef-core-runtime-schema --interface Elsa.EntityFrameworkCore.Common.Contracts.IElsaDbContextSchema -- migrations add V3_3 -c ""$module""ElsaDbContext -p ""$providerPath""  -o ""$migrationsPath""
    done
done
